...
Ниже приведен пример который взят из статьи "Основы компьютерных сетей. Тема №1. Основные сетевые термины и сетевые модели" который должен помочь в разобраться с процессом инкапсуляции и деинкапусуляции.
