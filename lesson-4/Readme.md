...
Определение максимального десятичного чиала в октете:
...
Маска подсети в IPv4- это 32-разрядное число, которое сегментирует существующий IP-адрес в сети TCP/IP. Он используется протоколом TCP/IP для определения того, находится ли хост в локальной подсети или в удаленной сети. 
